package com.chanoyfran.meli.wire.postgresql.infrastructure;
...
@EnableJpaRepositories(basePackages = {"com.chanoyfran.meli"}) // Scan classes that extend from JpaRepository or CrudRepository
